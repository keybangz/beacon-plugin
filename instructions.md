...
Make sure this file is added into .gitignore
...
This is a OpenCode plugin that provides commands and utilities to OpenCode for a more in-depth, more efficient and faster alternative to grep.
